...
const initialJobs: Job[] = [
  {
    ...
    description:
      "We are seeking a talented and passionate Software Engineer to develop and maintain high-quality software applications.",
    overview:
  ...
  },
  {
    ...
    description:
      "We are seeking a highly motivated and experienced Product Manager to lead the development and execution of our product roadmap.",
    overview:
  ...
  },
  {
    ...
    description:
      "We are looking for a talented and passionate UX Designer to create intuitive and engaging user experiences for our digital products.",
    overview:
